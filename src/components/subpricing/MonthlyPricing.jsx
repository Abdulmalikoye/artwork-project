      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-purple-50 p-6 rounded-lg shadow-md">
          ...
          <ul className="mb-6">
            ...
            <li className="flex items-center mb-2">
              {/* <Check size={20} className="text-purple-600 mr-2" /> */}
              <span className="text-sm">Unlimited art pieces for sale.</span>
            </li>
            <li className="flex items-center mb-2">
              {/* <Check size={20} className="text-purple-600 mr-2" /> */}
              <span className="text-sm">1% commission on each sale.</span>
            </li>
            <li className="flex items-center mb-2">
              {/* <Check size={20} className="text-purple-600 mr-2" /> */}
              <span className="text-sm">
                Personalized analytics dashboard with in-depth reporting.
              </span>
            </li>
            <li className="flex items-center mb-2">
              {/* <Check size={20} className="text-purple-600 mr-2" /> */}
